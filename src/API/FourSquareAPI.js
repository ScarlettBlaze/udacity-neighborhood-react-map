...
class Helper {
    ...
    static auth() {
        const keys = {
            client_id: "WEDS52NIE3ONALJJ2YS3HM0E22WOSK5R0LQIZQNWOXKBQV3N",     // Client Key.
            client_secret: "BPFMD03ZCZEHZMNN50AADIEUYC0RGAG3C1U3QEKZEXJRKK5E", // Secret Key.
            v: "20181113"                                                      // Version (Date YYYYMMDD)
        };
